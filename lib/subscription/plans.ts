...
export const QUANT_PLANS: Record<QuantPlanTier, PlanDefinition> = {
  free: {
    id: "free",
    name: "Free",
    tagline: "Try the cockpit on real searches.",
    monthlyPriceEur: 0,
    searchesPerDay: 20,
    ...
    highlights: [
      "Live signed-in search",
      "QI scoring & compare (3 listings)",
      "Saved tray (limited)",
      "Watchlist foundation (limited)",
    ],
  },
  pro: {
    id: "pro",
    name: "Pro",
    tagline: "For buyers who want depth without noise.",
    monthlyPriceEur: 19,
    searchesPerDay: 120,
    ...
    highlights: [
      ...
      "Smarter alerts & advisor depth",
      "Higher daily search & AI limits",
  ...
  premium: {
    id: "premium",
    name: "Power Buyer",
    tagline: "Full-spectrum intelligence for high-stakes carts.",
    monthlyPriceEur: 49,
    searchesPerDay: 400,
    ...
    advancedAdvisor: true,
    highlights: [
      "Full global deal intelligence",
      "Maximum search & AI throughput",
      "Unlimited watchlist",
