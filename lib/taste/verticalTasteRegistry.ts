...
export const VERTICAL_TASTE_REGISTRY: VerticalTasteRegistryEntry[] = [
  ...
  entry("furniture_minimal_office", furnitureTasteGrammar),
  entry("furniture_executive_workspace", furnitureTasteGrammar),
  entry("furniture_ergonomic_premium", furnitureTasteGrammar),
  entry("furniture_studio_clean", deskSetupTasteGrammar),
  entry("furniture_architectural_minimal", furnitureTasteGrammar),
